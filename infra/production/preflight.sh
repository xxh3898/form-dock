...
CANONICAL_PROJECT="$FORMDOCK_PRODUCTION_PROJECT"
CANONICAL_WEB_PORT="$FORMDOCK_PRODUCTION_WEB_PORT"
CANONICAL_RELEASE_SHA="$FORMDOCK_PRODUCTION_RELEASE_SHA"
CANONICAL_API_IMAGE="$FORMDOCK_PRODUCTION_API_IMAGE"
CANONICAL_WEB_IMAGE="$FORMDOCK_PRODUCTION_WEB_IMAGE"
