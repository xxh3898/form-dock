...
public record CanonicalResponsePayload(String json, String sha256, List<CanonicalAnswer> answers) {
    ...
    public CanonicalResponsePayload {
        ...
        answers = List.copyOf(Objects.requireNonNull(answers, "Canonical answers are required"));
