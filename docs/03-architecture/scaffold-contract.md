...
3. Phase 2-A Survey DRAFT Core — next authorized Product slice
4. Phase 2-B Question/Lock Data Foundation — after 2-A merge/verification
5. Phase 2-C Survey Builder Backend Completion — after 2-B merge/verification
...
Creator Foundation은 `main`에 release됐다. Phase 2는 owner-scoped Survey/Question Builder, Admin preview와 ADR-0006 schema-only lock authority만 구현할 수 있으며 첫 Product slice는 Phase 2-A다. Public Survey/Response, Result/CSV와 Production은 별도 승인 전 구현하거나 활성화하지 않는다.
